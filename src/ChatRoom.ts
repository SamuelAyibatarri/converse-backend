...
export class ChatRoom extends DurableObject<Bindings> {
  ...
  async persistAndBroadcast(message: Interfaces.Chat, threadId: string) {
    ...
    try {
      console.log("This is the received msg before sql command: ", message, " thread id: ", threadId)
    ...
    console.log("This is the broadcasted message to the other clients: ", { type: 'message', ...message })
  }
